...
public class SeleniumWorkFlow
{
  ...
  public void clickedBrowserBackButton(int index,String page,String xpathKey, String identifier)
  {
    WebBrowser.setCurrentBrowser(index);
    browser=WebBrowser.getBrowser();
    WebBrowserUtil.attachPage(page);
    try
    {
      WebBrowserUtil.clickBrowserBackButton();
    }
    catch(Exception ex){}
  }
  public boolean verifyCopiedTextNotPresentByIndex(String param,int index,String page,String xpathKey, String identifier)
  {
    WebBrowser.setCurrentBrowser(index);
    browser=WebBrowser.getBrowser();
    WebBrowserUtil.attachPage(page);
